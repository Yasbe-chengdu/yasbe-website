export default {
  ...
  "globalPayments": {
    ...
    "subtitle": "We work with top-tier banks, payment providers, and liquidity partners to enable fast, secure, and efficient global transfers. Our network spans over 28 countries and continues to grow.",
    "cards": {
      "trust": {
  ...
  "worldMap": {
    ...
    "description": "Stablecoins move money at the speed of the internet, overcoming traditional banking inefficiencies.",
    "cta": "Learn More"
  },
  "features": {
    ...
    "slide1": {
      ...
      "description": "Compare and convert between currencies and cryptocurrencies in real time. Stay updated with the latest rates and make informed decisions instantly.",
      "cta": "Try Now"
    },
    "slide2": {
      "visualButton": "Trade Securely",
      "title": "Unlock Security for Your Digital Transactions",
      "description": "Trust is built on security, and we take both seriously. With Institutional OTC, every fiat or crypto transaction is protected by encryption, risk controls, and compliance-grade safeguards."
    },
    "slide3": {
      "title": "Institutional OTC",
      "description": "Stablecoins are a key part of modern payments. Institutional OTC enhances YASBe's infrastructure to move money faster, smarter, and cheaper.",
      "listTitle": "What Institutional OTC gives you:",
      "listItems": "Competitive pricing & minimal slippage<br />Real-time access to liquidity across fiat & crypto<br />Custom OTC strategies just for you",
      "cta": "Find Out More"
    },
    "slide4": {
      "title": "Dual Asset Diversification",
      "description": "The future of investing isn't either crypto or traditional assets, it's both. Invest across borders, markets, and asset classes seamlessly.",
  ...
  "legalPage": {
    "sidebar": {
      ...
      "programPrivacyPolicy": "Program Privacy Policy",
      "programMobileWalletTerms": "Program Mobile Wallet Terms and Conditions"
    },
    "content": {
      ...
      "programPrivacyPolicy": { "title": "Program Privacy Policy" },
      "programMobileWalletTerms": { "title": "Program Mobile Wallet Terms and Conditions" }
    },
